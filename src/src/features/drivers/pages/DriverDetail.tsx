...
export function DriverDetail() {
  ...
  // Carreira inteira (todas as temporadas), direto da API — substitui os
  // números fixos do JSON local, que sempre "travavam" no tempo. Também
  // usada para calcular os pódios da temporada atual (ver mais abaixo).
  ...
  const seasonPodiums = careerStats?.seasonPodiums ?? driver.season?.podiums ?? 0;
